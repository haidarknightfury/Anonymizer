...
@Component
public class NameAnonymizationStrategy implements Converter<List<SourceValue>, List<SourceValue>> {
    ...
    public List<SourceValue> convert(List<SourceValue> source) {
        return this.anonymisationAsyncMgr.<Person>executeAsync(source, this.personRepository, Person::getFirst);
    }
}
