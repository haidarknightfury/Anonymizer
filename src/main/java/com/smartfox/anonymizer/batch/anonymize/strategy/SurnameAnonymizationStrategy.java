...
@Component
public class SurnameAnonymizationStrategy implements Converter<List<SourceValue>, List<SourceValue>> {
    ...
    public List<SourceValue> convert(List<SourceValue> source) {
        return this.anonymisationAsyncMgr.<Person>executeAsync(source, this.personRepository, Person::getLast);
    }
}
