...
@Component
public class CommentAnonymizationStrategy implements Converter<List<SourceValue>, List<SourceValue>> {
    ...
    public List<SourceValue> convert(List<SourceValue> source) {
        return this.anonymisationAsyncMgr.executeAsync(source, () -> "Lorum Ipsum");
    }
